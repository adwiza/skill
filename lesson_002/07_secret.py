...
first_word = secret_message[0][5]
second_word = secret_message[1][10:14]
third_word = secret_message[2][6:16]
third_word = third_word[::2]
fourth_word = secret_message[3][8:14]
fourth_word = fourth_word[::-1]
fifth_word = secret_message[4][178:22]
